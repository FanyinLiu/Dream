...
const kling: Tool = {
  ...
  slug: "kling",
  name: "Kling",
  tagline: "High-quality AI video generation from Kuaishou",
  description:
    "Kling is a powerful AI video generation tool by Kuaishou. It supports text-to-video and image-to-video with impressive quality, competing directly with Runway and Pika in the AI video space.",
  categories: ["video"],
  subcategories: ["视频生成"],
  tags: ["视频生成", "高质量", "文生视频"],
  officialUrl: "https://klingai.com",
  priceType: "freemium",
  priceNote: "免费额度可用，Pro $8/月起",
  chineseSupport: true,
  ...
  pros: ["视频质量高", "免费额度慷慨", "支持多语言", "生成速度快"],
  cons: ["国际版功能不如国内版完整", "高级功能仍在迭代", "导出分辨率有限制"],
  featured: true,
  status: "active",
  rating: 4.5,
  logoText: "KL",
